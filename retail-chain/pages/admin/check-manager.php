...
<head>
  ...
  <link id="pagestyle" href="../../assets/css/manager.css" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ps--active-y">
    <nav class="navbar navbar-main navbar-expand-lg shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true"></nav>
    ...
    <div class="container" id="render-edit-manager">
    </div>
  </main>
  </div>
  <!--   Core JS Files   -->
  ...
  <script src="check-manager.js"></script>
</body>
