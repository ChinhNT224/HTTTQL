...
<head>
  ...
  <link id="pagestyle" href="../../assets/css/product-manager.css" rel="stylesheet" />
</head>

<body class="g-sidenav-show  bg-gray-100" id="style-2">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 fixed-start shadow box-shadow-sm pt-3" id="sidenav-main">
    <div class="sidenav-header h-10">
      <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      <span class="navbar-brand m-0">
        <img src="../../assets/img/favicon.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold"><?php
          echo $saleInfo['ManagerName']
        ?></span>
      </span>
      <span class="d-none" id="manager-id"><?php echo $managerId ?></span>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="./employee-manager.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
